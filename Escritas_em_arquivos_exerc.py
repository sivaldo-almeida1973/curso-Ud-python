...
relatorio = {}#dicionario

with open('LucrosEmpresa.txt') as LE:
  for linha in LE:
    relatorio[linha[0:3]] = int(linha[5:])#a chave do #dicionario é o mes (da posicao 0 até a posicao 3), e #o valor é o lucro (da posicao 5 ate o final da linha)
